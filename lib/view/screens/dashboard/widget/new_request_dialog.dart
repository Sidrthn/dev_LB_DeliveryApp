...
class NewRequestDialog extends StatefulWidget {
  ...
  final int orderId;
  const NewRequestDialog({super.key, required this.isRequest, required this.onTap, required this.orderId});
...
class _NewRequestDialogState extends State<NewRequestDialog> {
  ...
  void _startAlarm() {
    ...
    final cache = AudioCache(prefix: 'assets/'); // Assuming your audio files are in the 'assets/' directory

    // Load and play the sound
    cache.load('notification.mp3').then((file) {
